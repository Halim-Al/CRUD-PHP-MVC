<div class="container text-center rounded">
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary d-inline-block">
    ...
    <div class="col-md-6 offset-md-3">
      <form action="/navlink/pelanggan" method="GET">
        ...
        <table class="table">
            ...
            <?php foreach ($model['pelangganData'] as $pelanggan): ?>
        <tr>
            ...
            <td>        <!-- Tombol Edit -->
                        <a href="/editpelanggan?id=<?= $pelanggan['id'] ?>" class="btn btn-info mb-sm-0 mb-1">Edit</a>
                        <!-- Tombol Delete -->
                        <button type="button" id="delete" class="btn btn-danger delete-btn" data-id="<?= $pelanggan['id'] ?>">Delete</button>
