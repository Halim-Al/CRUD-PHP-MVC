...
<div class="container text-center rounded">
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary d-inline-block">
    ...
    if ($currentPage > 1) {
        echo "<a class='page-link rounded-sm' href='?page=$prevPage&query=$query'>&laquo; Previous</a> ";
    }
    ...
    if ($currentPage < $totalPages) {
      echo "<a class='page-link rounded-sm' href='?page=$nextPage&query=$query'>Next &raquo;</a> ";    }
    ?>
</div>
